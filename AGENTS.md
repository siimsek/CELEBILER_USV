...
`OTOMASYON.md` ana otomasyon mimarisi referansıdır; bu dosyadaki operasyon, kontrol sahipliği ve sim-to-real kuralları OTOMASYON.md ile uyumlu tutulur.
...
- `config/pixhawk_ida.param` mevcut teknede manuel sürüşle çalışan Pixhawk baseline'ıdır; bu dosya değiştirilmeden önce `OTOMASYON.md` içindeki Pixhawk Param Baseline kontrol edilir.
